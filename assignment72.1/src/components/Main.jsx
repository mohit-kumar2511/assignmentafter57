...
import CheckedInput from './CheckedInpute';
      ...
      <div className='mt-8'>
        ...
        {pendingData.length === 0 ? (
          ...
          pendingData.map((item, index) => (
            <Input key={index} data={item} markTask={markTask} deleteTask={deleteTask} />
          ))
        )}
      </div>
      ...
      <div className='mt-4'>
        ...
        {completedData.length === 0 ? (
          ...
          completedData.map((item, index) => (
            <CheckedInput key={index} data={item} markTask={markTask} deleteTask={deleteTask} />
          ))
        )}
      </div>
    </div>
